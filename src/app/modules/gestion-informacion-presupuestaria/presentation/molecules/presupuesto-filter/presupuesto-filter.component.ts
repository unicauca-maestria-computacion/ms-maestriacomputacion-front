 ...
 * Agrupa átomos (inputs + botón) en una unidad funcional de filtrado.
 * REGLA: Sin inyección de servicios. Comunica hacia arriba via @Output.
 * El Organismo/Page que la contiene decide qué hacer con el filtro emitido.
 */
...
export class PresupuestoFilterComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    // Emite el filtro automáticamente con debounce al escribir
